...
par(new=T)
plot(x, y2, type="l", xlim=c(7, 12), ylim=c(0, 1.5), lty=2, xlab="", ylab="")
par(new=T)
plot(x, y3, type="l", xlim=c(7, 12), ylim=c(0, 1.5), lty=3, xlab="", ylab="")
par(new=T)
...
par(new=T)
plot(x, y2, type="l", xlim=c(9, 15), ylim=c(0, 1.5), lty=2, xlab="", ylab="")
par(new=T)
